...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function update(Admin $admin, AdminRequest $request)
    {
        ...
        //dd($request->input('dealership_id'));
        ...
        return redirect(route('admin.show'))->with('success', "{$admin->name} details are successfully updated");
    ...
    public function destroy(Admin $admin)
    {
        ...
        return redirect(route('admin.show'))->with('success', "You have deleted {$prefix} successfully");
    }
}
